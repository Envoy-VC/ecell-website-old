			...
			{people.map((testimonial, idx) => (
				...
				>
					...
					<img
						...
						className='relative !m-0 h-[5.75rem] w-[5.75rem] rounded-full border-2 border-white object-cover object-top !p-0 transition duration-500 group-hover:z-30  group-hover:scale-[115%] sm:h-24 sm:w-24 md:h-36 md:w-36'
					/>
				</div>
			))}
		</div>
